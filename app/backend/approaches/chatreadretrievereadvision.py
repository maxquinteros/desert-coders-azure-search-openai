...
class ChatReadRetrieveReadVisionApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """
        You are an assistant for doctors, and your main function is to help recognize different diseases based on the symptoms presented by patients. You have to identify which diseases may result from these symptoms using the documentation in your database., The documents contain text, graphs, tables and images.
